...
import ProjectLiveChart from '~/legacy/mobile/components/ProjectLiveChart.vue'
import ReconnectSheet from '~/legacy/mobile/components/ReconnectSheet.vue'
import ReconnectorPanel from '~/legacy/mobile/components/ReconnectorPanel.vue'
import InvertersSheet from '~/legacy/mobile/components/InvertersSheet.vue'
...
import FallaCreateSheet from '~/legacy/mobile/components/FallaCreateSheet.vue'
import FallaDetailSheet from '~/legacy/mobile/components/FallaDetailSheet.vue'
