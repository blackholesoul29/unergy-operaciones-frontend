...
import FACTURAS_SOL_ESTATICAS from '~/legacy/assets/facturas_solenium_data.js'
import FACTURAS_INV_ESTATICAS from '~/legacy/assets/facturas_inversionistas_data.js'
