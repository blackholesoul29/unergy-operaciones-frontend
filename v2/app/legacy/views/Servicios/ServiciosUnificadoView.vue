...
const ClienteForm = defineAsyncComponent(() => import('~/legacy/views/Clientes/ClienteForm.vue'))
const ProyectoForm = defineAsyncComponent(() => import('~/legacy/views/Proyectos/ProyectoForm.vue'))
const PPAContratoWizard = defineAsyncComponent(() => import('~/legacy/views/Contratos/PPAContratoWizard.vue'))
const ContratoServicioWizard = defineAsyncComponent(() => import('~/legacy/views/Contratos/ContratoServicioWizard.vue'))
