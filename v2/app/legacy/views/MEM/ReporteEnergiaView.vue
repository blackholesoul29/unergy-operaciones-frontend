...
<script setup>
import { ref } from 'vue'
import ReporteEnergiaAutomatizacionView from '~/legacy/views/MEM/ReporteEnergiaAutomatizacionView.vue'
import ReporteCGMView from '~/legacy/views/MEM/ReporteCGMView.vue'
