...
.td-type { font-size: 15px; font-weight: 700; color: var(--color-unergy-deep); }
...
.td-textarea {
  ...
  font-family: inherit; color: var(--color-unergy-deep); background: #fff;
}
...
.td-seg-user { font-weight: 700; color: var(--color-unergy-deep); }
