        ...
        <div class="fd-sheet">
          ...
          <div class="fd-body">
            ...
            <div class="fd-field">
              ...
              <select
                class="fd-select"
                :value="fa.asignado_a?.id ?? ''"
                @change="
                  cambiar({
                    asignado_a_id: $event.target.value ? Number($event.target.value) : null,
                  })
                "
              >
            ...
            <div class="fd-facts">
              ...
              <div class="fd-fact">
                <span>Identificada</span><b>{{ fmtFecha(fa.fecha_identificacion) }}</b>
              </div>
              <div class="fd-fact">
              ...
              <div v-if="fa.energia_perdida_kwh != null" class="fd-fact">
                <span>Energía perdida</span
                ><b class="fd-bad"
                  >{{ Number(fa.energia_perdida_kwh).toLocaleString('es-CO') }} kWh</b
                >
              </div>
            </div>
            ...
            <div class="fd-segs">
              ...
              <div v-for="s in fa.seguimientos || []" :key="s.id" class="fd-seg">
                ...
                <span
                  v-if="s.estado_nuevo"
                  class="fd-seg-estado"
                  :style="chipOn(s.estado_nuevo.color_hex)"
