  ...
  <div class="ms-root">
        ...
        <div class="ms-picker-card">
          ...
          >
            ...
            <i
              ...
              class="pi pi-bolt ms-picker-relay"
          ...
          <div v-if="(fallasMap[p.proyecto_id] || []).length" class="ms-fallas">
            ...
            >
              <span
                ...
                :style="{ background: f.prioridad?.color_hex || '#9ca3af' }"
              />
              <span
                class="ms-falla-estado"
                :style="{
                  background: (f.estado?.color_hex || '#915BD8') + '22',
                  color: f.estado?.color_hex || '#915BD8',
                }"
    ...
    <div v-else class="ms-state">
      <template v-if="loadingList"
        ><i class="pi pi-spin pi-spinner" /> <span>Cargando proyectos…</span></template
      >
      <template v-else>
