...
<template>
  <div class="flex flex-col gap-6">
    <div>
      <h3 class="mb-2 text-sm font-semibold" style="color: #2c2039">Registrar gestión</h3>
      <div class="mb-4 flex flex-col gap-2">
        ...
        <div class="flex flex-wrap items-center gap-2">
          <Button
            ...
            size="small"
            :loading="guardando"
            :disabled="!nueva.tipo || !nueva.descripcion"
            @click="registrar"
          />
      ...
      <h3 class="mb-2 text-sm font-semibold" style="color: #2c2039">Gestiones</h3>
      <p v-if="!gestiones.length" class="text-sm" style="color: #9b89b5">
      ...
      <ul class="flex flex-col gap-2">
        ...
        >
          <div class="mb-1 flex flex-wrap items-center gap-2 text-xs" style="color: #9b89b5">
    ...
    <div>
      <h3 class="mb-2 text-sm font-semibold" style="color: #2c2039">Historial de etapas</h3>
