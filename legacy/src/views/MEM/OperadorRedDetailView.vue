<template>
  <div class="space-y-4" v-if="operador">
    ...
    <div class="flex items-center gap-3">
      <button
        @click="$router.push('/mem/operadores-red')"
    ...
    <div class="overflow-hidden rounded-xl bg-white shadow-sm" style="border: 1px solid #e8e0f0">
      <div class="flex border-b" style="border-color: #e8e0f0">
        <button
          ...
          class="-mb-px border-b-2 px-5 py-3 text-sm font-medium transition-colors"
          :style="
            activeTab === tab.key
        ...
        <div v-if="activeTab === 'contactos'" class="space-y-3">
          ...
          <div v-for="c in operador.contactos" :key="c.id" class="flex items-center gap-2">
            ...
            <input
              ...
              @blur="guardarContacto(c)"
              class="flex-[4] rounded-lg px-3 py-2 text-sm outline-none"
          ...
          <div v-if="nuevo" class="flex items-center gap-2">
            ...
            <input
              ...
              style="border: 1.5px solid #e8e0f0; background: #fff"
            />
            <button type="button" @click="nuevo = null" class="rounded-lg p-1.5 hover:bg-gray-50">
...
const tabs = [{ key: 'contactos', label: 'Contactos', icon: 'pi pi-envelope' }]
