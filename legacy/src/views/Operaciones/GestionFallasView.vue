<template>
  <div class="gf-page" ref="pageRef">
    ...
    <div class="gf-sticky-header" ref="stickyHeaderRef">
      ...
      <div class="gf-topbar">
        <div class="gf-topbar-title">
          ...
          <h2 class="text-base font-bold whitespace-nowrap text-gray-800">Gestión de Fallas</h2>
        </div>
        ...
        <div :class="['gf-table-wrap', drawerVisible && 'lg:!hidden']">
          ...
          >
            ...
            <Column field="codigo_interno" header="Código" style="width: 110px" sortable>
              <template #body="{ data }">
                <code class="rounded bg-gray-50 px-1.5 py-0.5 font-mono text-xs text-gray-700">{{
                  data.codigo_interno
                }}</code>
              </template>
            </Column>
        ...
        <div class="gf-aside-panel">
          ...
          <div class="gf-drawer-header">
            ...
            <div class="min-w-0 flex-1">
              <div class="flex flex-wrap items-center gap-2">
                <code class="rounded bg-purple-50 px-2 py-0.5 font-mono text-sm text-purple-700">{{
          ...
          <div class="gf-drawer-body">
            ...
            <section class="gf-hero">
              ...
              <dl class="gf-facts">
                ...
                <div class="gf-fact">
                  ...
                  <dd class="gf-fact-value">
                    <div v-if="drawerFalla.asignado_a" class="flex items-center gap-1.5">
                      <div class="avatar-xs" :style="avatarStyle(drawerFalla.asignado_a)">
                        {{ initials(drawerFalla.asignado_a.nombre) }}
                      </div>
                ...
                <div v-if="drawerFalla.tiempo_afectacion_horas != null" class="gf-fact">
                  ...
                  <dd class="gf-fact-value font-semibold" style="color: #b45309">
            ...
            <section class="gf-section">
              ...
              <div v-else-if="sortedSeguimientos.length" class="mt-3 space-y-3">
              ...
              <p v-else class="mt-3 text-sm text-gray-500">Aún no hay seguimientos registrados.</p>
            </section>
    ...
    <Dialog
      v-model:visible="resolveDialog.visible"
      modal
...
async function onSaveForm(payload) {
  ...
  try {
    if (editingFalla.value) {
      ...
      if (notaInicial) {
        api
          .post(`/fallas/${editingFalla.value.id}/seguimientos`, { nota: notaInicial })
          .catch(() => {})
      }
