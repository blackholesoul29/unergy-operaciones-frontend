  ...
  <div class="space-y-5">
    ...
    <div v-if="!resultado" class="space-y-4">
      <div
        ...
        :style="
          dragging
            ? 'border-color:#915BD8;background:rgba(145,91,216,0.04)'
            : 'border-color:#c4b8d4;background:#fafafa'
        "
      ...
      >
        ...
        <i class="pi pi-file-excel mb-2 block text-3xl" style="color: #c4b8d4" />
        <p class="text-sm font-medium" style="color: #6b5a8a">Archivo TXR — hoja "Ajuste"</p>
        <p class="mt-1 text-xs" style="color: #9ca3af">Arrastra o haz clic para seleccionar</p>
      </div>
          ...
          <thead>
            <tr class="border-b bg-gray-50">
              <th
                ...
                :key="col"
                class="sticky top-0 bg-gray-50 px-3 py-2 text-left font-semibold"
                style="color: #6b5a8a"
              >
                {{ col }}
              </th>
            ...
            >
              <td v-for="col in resultado.headers" :key="col" class="px-3 py-1.5 tabular-nums">
                <span
                  ...
                  :style="
                    esUNGC(row)
                      ? 'background:#f3f0f7;color:#915BD8'
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div class="space-y-1">
            ...
            <input
              ...
              readonly
              class="w-full rounded-lg bg-gray-50 px-3 py-2 text-sm"
