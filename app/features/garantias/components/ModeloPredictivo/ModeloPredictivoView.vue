<template>
  <div class="space-y-4">
    ...
    <div class="flex flex-wrap items-end gap-4 p-4 rounded-xl"
      ...
      <Button label="Recalcular" :loading="cargando" outlined @click="cargar">
    ...
    <div v-if="error" class="rounded-xl p-5 text-center"
      ...
      <ClockIcon class="size-6 block mb-2 mx-auto" style="color:#c4b8d4" />
...
import { ClockIcon, RefreshCwIcon } from '@lucide/vue'
...
watch(error, (msg) => {
  if (msg) toast.error('No se pudo cargar el plan de garantías', { description: msg, duration: 6000 })
})
